...
@section('admin-content')
    <div class="page-header">
        <div class="page-title">
            <h4>Nouveau Format</h4>
            <h6>Créer nouveau Format</h6>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.tailles.store') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Format</label>
                            <input type="text" name="taille" placeholder="Entrer une taille ( Ex: 1)"  autofocus value="{{ old('taille') }}">
                        </div>
                    </div>
