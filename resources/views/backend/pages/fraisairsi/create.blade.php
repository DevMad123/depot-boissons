...
@section('admin-content')
    <div class="page-header">
        <div class="page-title">
            <h4>Nouveau Frais AIRSI</h4>
            <h6>Créer nouveau Frais AIRSI</h6>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.fraisairsis.store') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Taux</label>
                            <input type="text" name="taux" placeholder="Entrer le Taux de frais AIRSI" autofocus
                                value="{{ old('taux') }}">
                        </div>
                    </div>
                    <div class="text-end">
