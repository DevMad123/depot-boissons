...
@section('admin-content')
    <div class="page-header">
        <div class="page-title">
            <h4>Nouveau emballage</h4>
            <h6>Créer nouveau emballage</h6>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.emballages.store') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Libelle </label>
                                <select name="libelle"  class="select" >
                                    <option value="">Sélectionner un emballage</option>
                                    <option value="Casier">Casier</option>
                                    <option value="Emballage Plastique">Emballage Plastique</option>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label for="qte_par_emballage">Quantité </label>
                                <input type="text"   name="qte_par_emballage" placeholder="Entrer la Quantité " autofocus value="{{ old('qte_par_emballage  ') }}">
                        </div>
                    </div>
                    <div class="text-end">
