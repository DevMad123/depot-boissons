...
@section('admin-content')
    <div class="page-header">
        <div class="page-title">
            <h4>Nouveau Tarif type produit client </h4>
            <h6>Créer nouveau Tarif type produit client</h6>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.tariftypeproduitclients.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="getUrlTemplate"
                                        value="{{ route('admin.tariftypeproduitclients.listeproduit', [':id1', ':id2']) }}">
                    ...
                    <div class="col-md-9">
                        <a href="{{ route('admin.tariftypeproduitclients.index') }}" class="btn btn-info">Retour</a>
                    </div>
                </div>
            </form>
        </div>
