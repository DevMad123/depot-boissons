...
@section('admin-content')
    <div class="page-header">
        <div class="page-title">
            <h4>Nouveau type produit</h4>
            <h6>Créer nouveau  type produit</h6>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.typeproduits.store') }}" method="POST">
                @csrf
                <div class="row">

                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Type de produit (Ex: Alcool, Sucrerie)</label>
                                <input type="text"  name="libelle" placeholder="Entrer un type de produit ( Ex: Alcool )"  autofocus value="{{ old('libelle') }}">
                        </div>
                    </div>
