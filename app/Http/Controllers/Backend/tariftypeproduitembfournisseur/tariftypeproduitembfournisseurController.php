...
namespace App\Http\Controllers\Backend\tariftypeproduitembfournisseur;

use App\Http\Controllers\Controller;
use App\Models\Tariftypeproduitembfournisseur;
...
class tariftypeproduitembfournisseurController extends Controller
{
      ...
      public function index()
      {
          ...
          $tariftypeproduitembfournisseurs = Tariftypeproduitembfournisseur::orderBy('created_at', 'desc')->get();
          return view('backend.pages.tariftypeproduitembfournisseur.index', compact('tariftypeproduitembfournisseurs'));
      }
